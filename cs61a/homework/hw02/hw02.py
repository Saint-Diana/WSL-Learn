...
def missing_digits(n):
    ...
    if n < 10:
        return 0
    last_digit = n % 10
    last_second_digit = (n // 10) % 10
    missing = 0
    if last_digit == last_second_digit or last_digit == last_second_digit + 1:
        missing = 0
    else:
        missing = last_digit - last_second_digit - 1
...
def count_coins(total):
    ...
    """
    # 有 1、 5、 10、 25 这四种硬币
    # 求出让和为 total 的组合数 count_partitions(25, 1)
    # @trace
