...
#define NODE_MAIN_LOGGER_NAME "pe_ars408_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpe_ars408_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<PeContinentalArs408Node>";
